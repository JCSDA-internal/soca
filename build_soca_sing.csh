...
ecbuild -DOOPS_PATH=${BUILD}/oops -DIODA_PATH=${BUILD}/ioda -DUFO_PATH=${BUILD}/ufo -DMOM6_LIBRARIES=${MOM6_LIBRARIES} -DMOM6_INCLUDE_DIRS=${MOM6_INCLUDE_DIRS} -DMOM6_HEADER_DIRS=${MOM6_HEADER_DIRS} -DMOM6_MACROS_DIRS=${MOM6_MACROS_DIRS} -DFMS_LIBRARIES=${FMS_LIBRARIES} -DFMS_INCLUDE_DIRS=${FMS_INCLUDE_DIRS} -DMPI_LIBRARIES=${MPI_LIBRARIES} -DMPI_INCLUDE_DIRS=${MPI_INCLUDE_DIRS} -D CMAKE_CXX_FLAGS="-fopenmp" ${SRC_MODEL}
make VERBOSE=1 -j1
