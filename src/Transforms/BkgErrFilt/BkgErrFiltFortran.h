...
#ifndef SRC_TRANSFORMS_BKGERRFILT_BKGERRFILTFORTRAN_H_
#define SRC_TRANSFORMS_BKGERRFILT_BKGERRFILTFORTRAN_H_
...
#endif  // SRC_TRANSFORMS_BKGERRFILT_BKGERRFILTFORTRAN_H_
