...
#ifndef SRC_LOCALIZATIONMATRIX_LOCALIZATIONMATRIX_H_
#define SRC_LOCALIZATIONMATRIX_LOCALIZATIONMATRIX_H_
...
#endif  // SRC_LOCALIZATIONMATRIX_LOCALIZATIONMATRIX_H_
