...
void LinearModel2GeoVaLs::multiply(const Increment & dxin, Increment &dxout) const {
...
void LinearModel2GeoVaLs::multiplyInverse(const Increment &, Increment &) const {
  util::abor1_cpp("LinearModel2GeoVaLs::multiplyInverse not implemented");
}

// -----------------------------------------------------------------------------

void LinearModel2GeoVaLs::multiplyAD(const Increment &dxin, Increment &dxout) const{
...
void LinearModel2GeoVaLs::multiplyInverseAD(const Increment &, Increment &) const{
