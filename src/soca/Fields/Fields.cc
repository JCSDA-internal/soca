...
namespace soca {
  ...
  // -----------------------------------------------------------------------------
  void Fields::rotate2north(const oops::Variables & u,
    ...
    soca_field_rotate2north_f90(keyFlds_, u, v);
  }
  // -----------------------------------------------------------------------------
  void Fields::rotate2grid(const oops::Variables & u,
                           const oops::Variables & v) const {
    ...
    // Assumes u_t and v_t are colocated
    soca_field_rotate2grid_f90(keyFlds_, u, v);
  }
  // -----------------------------------------------------------------------------
