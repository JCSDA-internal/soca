...
#ifndef SOCA_LINEARVARIABLECHANGE_VERTCONV_VERTCONVFORTRAN_H_
#define SOCA_LINEARVARIABLECHANGE_VERTCONV_VERTCONVFORTRAN_H_
...
#endif  // SOCA_LINEARVARIABLECHANGE_VERTCONV_VERTCONVFORTRAN_H_
