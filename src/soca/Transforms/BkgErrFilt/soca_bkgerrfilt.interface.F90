...
!< C++ interface for soca_bkgerrfilt_mod::soca_bkgerrfilt
...
! soca modules
use soca_bkgerrfilt_mod, only: soca_bkgerrfilt
...
#define LISTED_TYPE soca_bkgerrfilt

!> Linked list interface - defines registry_t type
#include "oops/util/linkedList_i.f"

!> Global registry for soca_bkgerrfilt
...
! ------------------------------------------------------------------------------
!> C++ interface for soca_bkgerrfilt_mod::soca_bkgerrfilt::setup()
!!
...
subroutine soca_bkgerrfilt_setup_c(c_key_self, c_conf, c_key_bkg, c_key_geom) &
  ...
  type(soca_bkgerrfilt), pointer :: self
...
end subroutine soca_bkgerrfilt_delete_c
