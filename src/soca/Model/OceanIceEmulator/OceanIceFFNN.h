...
struct OceanIceFFNN : torch::nn::Module {
  OceanIceFFNN(int inputSize, int hiddenSize, int outputSize, int kernelSize = 1, int stride = 1) {
    oops::Log::trace() << "Starting OceanIceFFNN constructor: "
