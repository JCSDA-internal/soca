...
# TODO, move these to a yaml configuration
gridspec_filename="./soca_gridspec.nc"
restart_filename="./MOM.res.nc"
mld_filename="./average_MLD.nc"
output_filename="./scales.nc"
output_variable_vt = 'vt'
output_variable_hz = 'hz'

VT_MIN=1.5
VT_MAX=10  #< important this is smaller than the number of layers in the mixed layer
           # otherwise there would be too many vt diffusion steps. You still
           # get correlation going from top of ocean to the MLD
